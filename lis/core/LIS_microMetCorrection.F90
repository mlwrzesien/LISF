...
! .............................................................
  ...
  do t=1,lis%ngrid(nest)
     ...
     force_lwd = lisdom(nest)%grid(t)%forcing(4)
     ...
     ! Total Precip. -- Elevation change:
     force_pcp = force_pcp*((1+0.00035*elevdiff)/(1-0.00035*elevdiff))

     ! Longwave radiation -- Elevation change:
     ea = e * 0.01
     ...
     ! Shortwave down radiation: Elevation change     

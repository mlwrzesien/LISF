...
end subroutine write_MOD10A1scf

!BOP
! !ROUTINE: MOD10A1_scfobsname
! \label{MOD10A1_scfobsname}
! 
! !INTERFACE: 
subroutine MOD10A1_scfobsname(n,k,obsname)
! !USES: 
...
end subroutine MOD10A1_scfobsname

...
!BOP
! !ROUTINE: noahmp401_qc_sweobsASO
! \label{noahmp401_qc_sweobsASO}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_qc_sweobsASO(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  call LIS_verify(status,&
       "ESMF_StateGet failed in noahmp401_qc_sweobs")
  call ESMF_FieldGet(obs_swe_field,localDE=0,farrayPtr=sweobs,rc=status)
  call LIS_verify(status,&
       "ESMF_FieldGet failed in noahmp401_qc_sweobs")
...
end subroutine noahmp401_qc_sweobsASO

...
!BOP
! !ROUTINE: noahmp401_descale_swe
! \label{noahmp401_descale_swe}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_descale_swe(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmp401_descale_swe

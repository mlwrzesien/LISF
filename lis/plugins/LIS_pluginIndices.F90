...
!-------------------------------------------------------------------------
   ...
   character*50, public,  parameter :: LIS_SnowGlobeTuoSWEId      = "SnowGlobeTuo SWE"
   character*50, public,  parameter :: LIS_SnowGlobePMWSWEId      = "SnowGlobePMW SWE"
   character*50, public,  parameter :: LIS_SnowGlobeIS2SNWDId      = "SnowGlobeIS2 Snow Depth"
   character*50, public,  parameter :: LIS_IS2extrapSNWDId      = "IS2extrap Snow Depth"
